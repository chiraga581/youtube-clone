...
const Head = () => {
    ...
    useEffect(()=> {
        ...
        // if the diffenrece between 2 api calls is less than 200 ms then decline the api call 
  ...
  return (
    <div className='grid grid-flow-col p-2 m-2 shadow-lg'>
        ...
        <div className='col-span-10 '>
            <div className='text-center'>    
                <input
                    ...
                    className='w-1/2 border border-gray-400 p-1 rounded-l-full px-5'
                    placeholder='Search'
                />
                <button className='border border-gray-400 py-1 px-3 bg-gray-100 hover:bg-gray-200 rounded-r-full'>🔍</button>
            </div>
            {
                showSuggestions && 
                <div className='fixed bg-white translate-x-64 translate-y-1 py-2 px-2 
                    w-[35.5rem] rounded-t-lg rounded-b-md shadow-2xl border border-gray-300'
                >
                    <ul>
                        {
        ...
        <div className='col-span-1 translate-x-20'>
            <img
